...
@section('content')
 ...
 <div id="content">
    ...
    <div class="line"></div>
    <h1 class="text-center font-weight-bold" style="padding-bottom: 2vh;font-size:3vw">Donatários Cadastrados</h1>
        ...
        <tbody>
            <tr>
                ...
                <td class="actions">
                    ...
                    <a class="btn btn-danger btn-xs"  href="#" data-toggle="modal" data-target="#deleteModal"><i class="fas fa-trash-alt"></i></a>
                </td>
            </tr>
        </tbody>
    </table>
