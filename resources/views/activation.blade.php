        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-center">
                    <h1>{{ __('Aguardando aprovação') }}</h1>
                    <svg class="bi bi-clock-history" width="5em" height="5em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="card-body text-center">
                    <h3>As informações cadastradas, estão em análise. Aguarde a aprovação da sua conta. Informaremos assim que sua conta for aprovada.</h3>
                </div>
            </div>
        </div>
    </div>
